...
#urlStr = ""
#requestData = "{\"tracking_number\":\"160093492\"}"
#result = tracker.trackingmore(requestData, urlStr, "carriers/detect")

#3 create a tracking number(新建一个单号)
#urlStr = ""
requestData = "{\"tracking_number\": \"160093492\",\"carrier_code\":\"tnt\",\"title\":\"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"destination_code\":\"US\",\"tracking_ship_date\":\"20180908\",\"tracking_postal_code\":\"12201\",\"lang\":\"en\",\"logistics_channel\":\"API TEST\"}"
result = tracker.trackingmore(requestData, urlStr, "post")

#4 List all trackings(列出所有跟踪)
#urlStr = "?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=160093492&orders=&lang=en"
#requestData = ""
#result = tracker.trackingmore(requestData, urlStr, "get")

#5 Get tracking results of a single tracking.
#urlStr = "/tnt/160093492/en"
#requestData = ""
...
#urlStr = ""
#requestData = "{\"tracking_number\": \"160093492\",\"carrier_code\":\"tnt\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
#result = tracker.trackingmore(requestData, urlStr, "realtime")

#10 Modify courier code(修改运输商)
#urlStr = ""
#requestData = "{\"tracking_number\": \"160093492\",\"carrier_code\":\"tnt\",\"update_carrier_code\":\"china-ems\"}"
...
#urlStr = ""
#requestData = "[{\"tracking_number\":\"160093492\",\"carrier_code\":\"tnt\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"tnt\"}]"
...
#urlStr = ""
#requestData = "[{\"carrier_code\":\"tnt\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
#result = tracker.trackingmore(requestData, urlStr, "costtime")

#16 Delete multiple tracking item(批量删除)
#urlStr = ""
#requestData = "[{\"tracking_number\":\"160093492\",\"carrier_code\":\"tnt\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
